...
public class HttpClientUtil {
 ...
 public static String doPostString(String url, String parameter) {
     ...
     */
    public static String doPostStringWithCert(String url, String password, String parameter) throws Exception {
        // 证书
        char[] passwordArr = password.toCharArray();
        String certPath = "c:/tmp/cert/apiclient_cert.p12";
        InputStream certStream = new FileInputStream(certPath);
        KeyStore ks = KeyStore.getInstance("PKCS12");
        ks.load(certStream, passwordArr);
